...
(function(){
  var ref$, mean, sum, id, map, fold, zip, filter, find, groupBy, objToPairs, head, tail, splitAt, join, zipAll, exports, experimentDataToHistogram, tableCoinDataManySum, mathSum, mathSumChance, graphCoinDataMany;
  ref$ = require('prelude-ls'), mean = ref$.mean, sum = ref$.sum, id = ref$.id, map = ref$.map, fold = ref$.fold, zip = ref$.zip, filter = ref$.filter, find = ref$.find, groupBy = ref$.groupBy, objToPairs = ref$.objToPairs, head = ref$.head, tail = ref$.tail, splitAt = ref$.splitAt, join = ref$.join, zipAll = ref$.zipAll;
  ...
  $(function(_){
    ...
    actions = {
      ...
      binomialConfidenceRangeAbs: function($div, mathJaxId){
        var _f, _fix, bins, left, right, chance, data, area, ref$, $vp, $block, x, y, math;
        _f = function(name){
      ...
      'binomial-polls': function(){
        var ref$, bins, chance, data, $block, confidenceData, format, x$, y$;
        ref$ = actions.binomialConfidenceRangeAbs($('#binomial-polls-histogram'), 'binomial-polls-histogram-math'), bins = ref$.bins, chance = ref$.chance, data = ref$.data, $block = ref$.$block;
        ...
        x$.select('td.link a').on('click', function(it){
          ...
          return actions['binomial-polls']();
        });
      },
      'binomail-ci': function(){
        var chance, bins, $ciRange, howManySigmas, mu, sigma, delta, left, right, data, area, x$, math, ref$, $vp, $block, x, y;
        chance = 0.5;
        bins = parseNum(
        ...
        ref$ = drawHistogram(d3.select('#ci-bins30'), data, {
          duration: 300,
          format: d3.format('%')
        }), $vp = ref$.$vp, $block = ref$.$block, x = ref$.x, y = ref$.y;
        $block.attr('class', function(it){
